...
DEFAULT_CONFIG_DIR = ROOT_DIR / "configs" / "uav_dualcog"
...
def build_stage_commands(
    *,
    ...
    probe_cmd = [
        python_bin,
        "scripts/uav_dualcog/probe_airsim_mapbound.py",
        "--config",
        str(config_path),
        "--scene-id",
        scene_id,
    ...
    stages.extend(
        [
            (
                ...
                [
                    python_bin,
                    "scripts/uav_dualcog/stage1_collect_pcd.py",
                    "--config",
                    str(config_path),
                    "--mode",
                    "all",
            ...
            (
                ...
                [
                    python_bin,
                    "scripts/uav_dualcog/stage2_landmark_label.py",
                    "--config",
                    str(config_path),
                    "--scene-id",
                    scene_id,
